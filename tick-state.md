...
- Status: **E1.1 backend 19/19 features done. E1.2 — 4/5 slices: FdsRoles contract ✅, FdsRoleSeedService ✅, FdsRolePolicies + Bootstrap ✅, RBAC audit + fix ✅. Tests: 103 Forms + 331 Identity + 54 Architecture. The 2 endpoint RBAC bugs (CreateProcessInstance + MarkCompleted) are fixed; TeamLead + PM now have full instance management (Create + Skip + Complete).**
- **Already done:**
...
- **E1.1 sub-slice backlog (under "continue" direction):**
  ...
  - [x] **UpdateProcessInstance** ✅ tick #17 — **backlog complete, 19/19 features**
- **Next epic (E1.2):**
